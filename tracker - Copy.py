...
class SettingsWindow(Toplevel):
    ...
    def __init__(self, master: Tk):
        ...
        self.geometry("1150x720") # Slightly larger for boxed layout
    ...
    def _init_styles(self):
        ...
        s.configure("TButton", background=self.BTN_COLOR, foreground=self.TEXT_COLOR, borderwidth=0, focusthickness=3, focuscolor='none', font=self.f_head, padding=5)
        ...
        # Style for the boxed LabelFrames
        s.configure("Box.TLabelframe", background=self.CONTENT_BG, relief="solid", borderwidth=1, bordercolor=self.BORDER_COLOR)
    ...
    def _init_layout(self):
        ...
        main_frame = Frame(self, bg=self.BG_COLOR, padx=5, pady=5)
    ...
    def _make_stats_page(self):
        ...
        bottom_frame.rowconfigure(1, weight=1) # Allow chart to expand
        ...
        if MATPLOTLIB_AVAILABLE: self._make_barchart(bottom_frame)
            ...
            Label(bottom_frame, text="Install 'matplotlib' to enable charts.", font=self.f_head, bg=self.CONTENT_BG, fg="orange").pack(pady=20)
    ...
    def _make_heatmap(self, parent):
        ...
        canvas_border = Frame(content, highlightbackground=self.BORDER_COLOR, highlightthickness=1, bg=self.CONTENT_BG)
        canvas_border.pack(fill=X, expand=True, pady=(5,0))
        self.heatmap_canvas = Canvas(canvas_border, bg=self.CONTENT_BG, height=130, highlightthickness=0)
        self.heatmap_canvas.pack(fill=X, expand=True, padx=2, pady=2)
    ...
    def _update_widget_fonts(self, parent_widget):
        ...
        for w in parent_widget.winfo_children():
            # This is a simplified logic, real-world might need more specific checks
            try:
                if 'font' in w.keys():
